...
@Component({
  selector: 'app-markdelevered',
  templateUrl: './markdelevered.component.html',
  styleUrls: ['./markdelevered.component.css'],  
  providers: [
    {
      provide: DateAdapter,
...
export class MarkdeleveredComponent implements OnInit {
