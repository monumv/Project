...
@Component({
  selector: 'app-debit-note-without-item',
  templateUrl: './debit-note-without-item.component.html',
  styleUrls: ['./debit-note-without-item.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class DebitNoteWithoutItemComponent implements OnInit {
