...
@Component({
  selector: 'app-salesreturncr',
  templateUrl: './salesreturncr.component.html',
  styleUrls: ['./salesreturncr.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class SalesreturncrComponent implements OnInit {
