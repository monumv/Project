...
import { IciciPayComponent } from '../icici-pay/icici-pay.component';
...
@Component({
  selector: 'app-proposed-payments',
  templateUrl: './proposed-payments.component.html',
  styleUrls: ['./proposed-payments.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class ProposedPaymentsComponent implements OnInit {
...
constructor(public dialog: MatDialog) {}
  ...
  openDialog() {
    this.dialog.open(IciciPayComponent,{
