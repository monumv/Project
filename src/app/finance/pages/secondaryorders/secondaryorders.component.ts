...
@Component({
  selector: 'app-secondaryorders',
  templateUrl: './secondaryorders.component.html',
  styleUrls: ['./secondaryorders.component.css'],
  encapsulation: ViewEncapsulation.None 
})
export class SecondaryordersComponent implements OnInit {
