...
sale:'10', work:'10,000', purchase:'Lorem', require:'535', pack:'test', produce:'Under Review', 
...
@Component({
  selector: 'app-undereview',
  templateUrl: './undereview.component.html',
  styleUrls: ['./undereview.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class UndereviewComponent implements OnInit {
