...
@Component({
  selector: 'app-areassignedemployee',
  templateUrl: './areassignedemployee.component.html',
  styleUrls: ['./areassignedemployee.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class AreassignedemployeeComponent implements OnInit {
