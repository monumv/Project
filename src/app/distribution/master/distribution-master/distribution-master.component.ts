...
@Component({
  selector: 'app-distribution-master',
  templateUrl: './distribution-master.component.html',
  styleUrls: ['./distribution-master.component.css']
})
export class DistributionMasterComponent implements OnInit {
