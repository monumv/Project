...
{position: 1, vch:'35', department: 'Accounts', document: 'Customer Care',  status: 'Sachin Chauhan', qty: '10',
...
export class SubdepartmentComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'position', 'vch', 'department',  'document',  'status', 'qty', 'pack', 'vacant', 'icon'];
