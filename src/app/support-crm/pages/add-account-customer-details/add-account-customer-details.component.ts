...
@Component({
  selector: 'app-add-account-customer-details',
  templateUrl: './add-account-customer-details.component.html',
  styleUrls: ['./add-account-customer-details.component.css'],
...
export class AddAccountCustomerDetailsComponent implements OnInit {
