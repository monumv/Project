...
@Component({
  selector: 'app-itemspending',
  templateUrl: './itemspending.component.html',
  styleUrls: ['./itemspending.component.css']
})
export class ItemspendingComponent implements OnInit {
