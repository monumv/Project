...
@Component({
  selector: 'app-productionslip',
  templateUrl: './productionslip.component.html',
  styleUrls: ['./productionslip.component.css'],  
  providers: [
    {
      provide: DateAdapter,
...
export class ProductionslipComponent implements OnInit {
  ...
  options: string[] = ['GetON Infotech Pvt. Ltd', 'CP Outlet'];

  myControls = new FormControl();
  optionss: string[] = ['Manish Kumar','Rahul Singh', 'Sanjay Jha', 'Jatin Sharma'];
