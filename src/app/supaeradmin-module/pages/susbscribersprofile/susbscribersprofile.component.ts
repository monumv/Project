...
@Component({
  selector: 'app-susbscribersprofile',
  templateUrl: './susbscribersprofile.component.html',
  styleUrls: ['./susbscribersprofile.component.css'],
...
export class SusbscribersprofileComponent implements OnInit {
  ...
  optionsss: string[] = ['Active', 'Expired'];
