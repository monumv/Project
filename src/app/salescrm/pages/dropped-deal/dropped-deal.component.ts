...
@Component({
  selector: 'app-dropped-deal',
  templateUrl: './dropped-deal.component.html',
  styleUrls: ['./dropped-deal.component.css']
})
export class DroppedDealComponent implements OnInit {
